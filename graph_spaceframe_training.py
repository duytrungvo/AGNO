...
from lib.utils_spaceframe_train import sup_graph_train, sup_graph_attn_train
from lib.utils_data import generate_graphspaceframe_data_loader
import random
import numpy as np
import os
...
if __name__ == "__main__":
    ...
    # load the data
    train_loader, val_loader, test_loader = generate_graphspaceframe_data_loader(args, config)
