...
from lib.utils_planeframe_train import sup_graph_train, sup_graph_attn_train
from lib.utils_data import generate_graphplaneframe_data_loader
...
if __name__ == "__main__":
    ...
    # load the data
    train_loader, val_loader, test_loader = generate_graphplaneframe_data_loader(args, config)
