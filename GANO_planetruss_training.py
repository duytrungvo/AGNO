...
from lib.model_truss import GANO, New_model_truss
from lib.utils_planetruss_train import sup_train
from lib.utils_data import generate_planetruss_data_loader_var_load
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='planetruss')
    ...
    # load the data
    train_loader, val_loader, test_loader, num_nodes_list = generate_planetruss_data_loader_var_load(args, config)
