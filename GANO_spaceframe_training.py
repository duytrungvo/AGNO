...
from lib.model_spaceframe import GANO, New_model_frame
from lib.utils_spaceframe_train import sup_train
from lib.utils_data import generate_spaceframe_data_loader
import random
import numpy as np
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='spaceframe')
    ...
    # load the data
    train_loader, val_loader, test_loader, num_nodes_list = generate_spaceframe_data_loader(args, config)
