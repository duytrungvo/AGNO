...
from lib.model_frame import GANO, New_model_frame
from lib.utils_planeframe_train import sup_train
from lib.utils_data import generate_planeframe_data_loader_var_load
import random
import numpy as np
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='planeframe')
    ...
    if args.model == 'self_defined':
        model = New_model_frame(config)

    # load the data
    train_loader, val_loader, test_loader, num_nodes_list = generate_planeframe_data_loader_var_load(args, config)
